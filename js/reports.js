    ...
    val.addEventListener("click", (e) => {
        ...
        if (e.target.innerHTML == "clients") {
            report__details.innerHTML = /*html*/`
                ...
                <my-details logic="client_7" text="7. Devuelve el nombre de los clientes que han **no**hecho pagos y el nombre de sus representantes junto con la ciudad de la oficina a la que pertenece el representante."></my-details>
        ...
        if (e.target.innerHTML == "employees") {
            report__details.innerHTML = /*html*/`
                ...
                <my-details logic="employee_6" text="6. Devuelve un listado que muestre solamente los empleados que no tienen una oficina asociada."></my-details>
                <my-details logic="employee_7" text="7. Devuelve un listado que muestre solamente los empleados que no tienen un cliente asociado."></my-details>
                <my-details logic="employee_8" text="8. Devuelve un listado que muestre solamente los empleados que no tienen un cliente asociado junto con los datos de la oficina donde trabajan."></my-details>
                <my-details logic="employee_9" text="9. Devuelve un listado que muestre los empleados que no tienen una oficina asociada y los que no tienen un cliente asociado."></my-details>
            `;
        }
